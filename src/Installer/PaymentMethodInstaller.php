...
namespace XrplConnector\Installer;
...
use XrplConnector\Components\PaymentHandler\XrpPaymentHandler;
use XrplConnector\XrplConnector;
...
class PaymentMethodInstaller
{
    ...
    {
        $pluginId = $this->pluginIdProvider->getPluginIdByBaseClass(XrplConnector::class, $context);
